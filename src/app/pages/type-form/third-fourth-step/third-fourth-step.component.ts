...
@Component({
  selector: 'app-third-fourth-step',
  templateUrl: './third-fourth-step.component.html',
  styleUrls: ['./third-fourth-step.component.scss'],

})
export class ThirdFourthStepComponent implements OnInit,OnDestroy{
